...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_50559edf_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "app/src/modules/App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-50559edf", Component.options)
  } else {
    hotAPI.reload("data-v-50559edf", Component.options)
  }
...
exports.default = {
    components: {
        addTask: _Task2.default //add-task component reçoit le Task.vue
    },
    ...
    methods: {
        ...
        spanAnimation: function spanAnimation() {
            this.$el.querySelector("h1>span").classList.add("animated", "hinge", "flip");
        },
        spanExitAnimation: function spanExitAnimation() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Task_vue__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ef087b7_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Task_vue__ = __webpack_require__(34);
var disposed = false
var normalizeComponent = __webpack_require__(2)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ef087b7_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Task_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "app/src/modules/Task.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5ef087b7", Component.options)
  } else {
    hotAPI.reload("data-v-5ef087b7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c(
    ...
    [
      _vm.editActive
        ? _c(
            ...
            [
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.taskprop.txt,
                    expression: "taskprop.txt"
                  }
                ],
                staticClass: "form-control",
                class: { error: _vm.isActive },
                staticStyle: {
                  "vertical-align": "middle",
                  display: "inline-block",
                  width: "auto",
                ...
                attrs: { type: "text" },
                domProps: { value: _vm.taskprop.txt },
                on: {
                  focus: _vm.focusActive,
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.taskprop.txt = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
        ...
        : _c("span", [_vm._v(_vm._s(_vm.taskprop.txt))]),
      _vm._v(" "),
      _c("button", { staticClass: "pull-right", on: { click: _vm.addDone } }, [
        _c("i", {
      ...
      _c(
        "button",
        { staticClass: "pull-right", on: { click: _vm.addUpdtask } },
        [
          _c("i", {
      ...
      _c(
        "button",
        { staticClass: "pull-right", on: { click: _vm.deletetask } },
        [
          _c("i", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5ef087b7", esExports)
  }
}
...
var render = function() {
  ...
  return _c("div", { staticClass: "container", attrs: { id: "app" } }, [
    _c("h1", { staticClass: "text-center" }, [
      _c(
        "span",
        {
          ...
          on: { mouseover: _vm.spanAnimation, mouseout: _vm.spanExitAnimation }
        },
        [_vm._v(_vm._s(_vm.titre))]
      )
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "text-center" }, [
      _c(
        "form",
        {
          ...
          attrs: { action: "", id: "form-task" },
          on: {
            submit: function($event) {
              $event.preventDefault()
              _vm.submitTask($event)
            }
          }
        },
        [
          _c("input", {
            ...
            staticClass: "form-control",
            class: { error: _vm.isActive },
            attrs: { type: "text", id: "input-task", placeholder: "new-task" },
          ...
          _c(
            ...
            {
              staticClass: "btn btn-primary",
              attrs: { type: "submit", id: "btn-add-task" }
            },
            [_vm._v("Add task")]
          )
        ]
    ...
    _c("h2", [
      _vm._v("tasks\n        "),
      _c("small", [_vm._v("Filtre: ")]),
      _vm._v(" "),
      _c(
        "button",
        {
          staticClass: "btn btn-success filter",
          attrs: { type: "button" },
    ...
    _c(
      ...
      _vm._l(_vm.tasks, function(task) {
        return _c("add-task", { key: task.id, attrs: { taskprop: task } })
      })
    )
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-50559edf", esExports)
  }
}
